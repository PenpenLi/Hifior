...
Shader "Shader Forge/Blend2Camera Ramp" {
    ...
    SubShader {
        ...
        Pass {
			...
			float3 emissive = lerp(_MainTex_var.rgb,_MainTex2_var.rgb,floor(saturate((_Blend + lerp((node_4058_if_leA*_Ramp_var.rgb) + (node_4058_if_leB*(1.0 - _Ramp_var.rgb)),_Ramp_var.rgb,node_4058_if_leA*node_4058_if_leB)))));
