...
namespace RPG.UI
{
    public class TidyUpPanel : IPanel
    {
        ...
        public void exchangeItem(int char_Index0, int item_Index0, int char_Index1, int item_Index1)
        {
            ...
            WeaponItem item0 = ch0.Item.GetItem(item_Index0);
            WeaponItem item1 = ch1.Item.GetItem(item_Index1);
            if (item0 == null)
                return;
            if (item1 == null)
            {
                ch0.Item.removeItem(item_Index0);
                ch1.Item.AddItem(item0);
            }
            else
            {
                ch0.Item.removeItem(item_Index0);
                ch1.Item.removeItem(item_Index1);
