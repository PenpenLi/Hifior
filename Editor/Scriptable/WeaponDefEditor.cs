    ...
    public class WeaponDefEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (foldout_AdditionalAttribute)
            {
                ...
                wea.AdditionalAttribute.Lucky = EditorGUILayout.IntSlider("幸运", wea.AdditionalAttribute.Lucky, 0, RPGEditorGlobal.MAX_ADDATTIBUTE);
            ...
            if (foldout_AdditionalAttiburteGrow)
            {
                ...
                wea.AdditionalAttributeGrow.Lucky = EditorGUILayout.IntSlider("幸运成长率", wea.AdditionalAttributeGrow.Lucky, 0, RPGEditorGlobal.MAX_ADDGROW);
