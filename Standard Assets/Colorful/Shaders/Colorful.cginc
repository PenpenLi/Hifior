/* Utils */
inline fixed luminance(fixed3 color)
{
	return dot(color, fixed3(0.30, 0.59, 0.11));
}

inline fixed rot(fixed value, fixed low, fixed hi)
{
...
inline fixed rot10(fixed value)
{
