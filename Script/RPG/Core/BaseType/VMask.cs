...
public struct VMask<T>
{
	public Int32 Value { get { return _value; } }

	public VMask(Int32 value)
	{
		_value = value;
	}
	public bool HasAny(Int32 mask)
	{
		return VMask.HasAny(_value, mask);
	}
	public bool HasAll(Int32 mask)
	{
		return VMask.HasAll(_value, mask);
	}
	public void Add(Int32 mask)
	{
		VMask.Add(ref _value, mask);
	}
	public void Del(Int32 mask)
	{
		VMask.Del(ref _value, mask);
	}
	public static implicit operator Int32(VMask<T> data)
	{
		return data.Value;
	}
	public static implicit operator UInt32(VMask<T> data)
	{
