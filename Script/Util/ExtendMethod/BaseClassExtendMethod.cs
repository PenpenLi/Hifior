...
public static class BaseClassExtendMethod
{
    ...
    {
        Utils.GameUtil.gameMode.StartCoroutine(IEnumDelayFunc(() => gameObject.SetActive(visible), delayTime));
    }
    ...
    {
        Utils.GameUtil.gameMode.StartCoroutine(IEnumDelayFunc(() => behavior.enabled = enable, delayTime));
    }
