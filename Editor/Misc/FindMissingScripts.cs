...
namespace RPGEditor
{
	...
	{
		[MenuItem("RPGEditor/Misc/Find Objects with Missing Scripts")]
		...
		private void ProcessObjects()
		{
			...
			if (!RPGEditorGlobal.SaveCurrentSceneIfUserWantsTo()) return;
			...
			if (string.IsNullOrEmpty(currScene)) RPGEditorGlobal.NewScene();
			else RPGEditorGlobal.OpenScene(currScene);
